...
const CONCERNS = [
  ...
  ["실제로 쓰이고 있다는 근거가 있나?", "2026년 7월 기준 하루 100여 명이 방문하고 있습니다. 별도 광고 없이 현장 QR 부착과 온라인 소개만으로 얻은 수치이며 꾸준히 늘고 있습니다. 현장에서도 이용자가 QR을 스캔해 확인하는 모습을 직접 확인했습니다. 정식 부착 이후에는 일간 접속자 추이를 정기적으로 완도군청에 공유해 드리겠습니다."],
