...
const children = [
  ...
  para([run("담당자: ____________________     연락처: ____________________", { size: 20, color: DARK })], { after: 60 }),
  para([run("이메일: ____________________", { size: 20, color: DARK })], { after: 60 }),
]
...
const outName = "FerryCast_완도군청_제안서.docx"
