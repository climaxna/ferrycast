...
조석 곡선 그래프, 내일 시간표 바텀시트, 지역 이동 바(RegionNav) — 완도 외 포항·목포·인천
항로도 동일 구조로 확장 운영 중, 완도군청 제안서 최신화(신규 화면 8종 재촬영 + 다지역
검증·이용현황 대응 문구 보강, `scripts/make-proposal-v2.mjs`로 docx·pdf 재생성).
