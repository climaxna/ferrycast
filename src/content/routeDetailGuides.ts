...
const GUIDES: Record<string, RouteDetailGuide> = {
  ...
  sangtaedo: {
    title: "목포 · 상태도(동리) 이용 안내",
    intro: "상태도(동리) 표기는 신의도 권역의 선착장을 뜻합니다. 상태도와 하태도는 간척으로 연결돼 현재 신의도에 속하므로, 숙소·픽업은 ‘신의도 상태동리’ 하선 기준으로 확인하는 것이 안전합니다.",
    checks: [
      { title: "도착지 이름 확인", description: "시간표에는 상태도(동리)로 표시되지만, 현지 주소·숙소·교통 정보는 신의도 또는 상태동리로 안내되는 경우가 많습니다. 예약 전 실제 하선 선착장을 전달하세요." },
      { title: "하의도와 구분", description: "하의도와 신의도는 하의3도라는 역사적 권역으로 함께 언급되지만 별도 섬입니다. 하의도 관광지나 숙소를 목적지로 잡았다면 섬 사이 이동 수단을 별도로 확인해야 합니다." },
      { title: "귀항편 우선 확인", description: "목포로 돌아오는 편은 항로·운항일에 따라 달라질 수 있습니다. 섬 안 이동이나 관광 일정을 시작하기 전 귀항 시각과 당일 운항 상태를 먼저 확인하세요." },
    ],
    source: { label: "한국해운조합 승선예약에서 최종 확인", href: BOOKING },
    tourHref: "/tour/jangsan-haui-sinui",
  ...
  uldo: {
    title: "인천 · 울도 이용 안내",
    intro: "울도는 덕적도 권역의 작은 섬으로, 인천에서 곧바로 들어가는 일반 항로와 다르게 표시될 수 있습니다. 출발 전 실제 연결 항로와 하선 가능 편을 확인하세요.",
    checks: [
      { title: "연결편 확인", description: "울도는 덕적도 진리선착장에서 이어지는 배편으로 안내됩니다. 인천 출발편과 울도행 연결편을 한 일정으로 확인하고, 환승 시간을 여유 있게 잡으세요." },
      { title: "현지 이용 여건", description: "작은 섬은 숙박·식당·교통 선택지가 제한적일 수 있습니다. 숙소나 식사 계획이 있다면 출발 전 운영 여부와 예약 조건을 확인하세요." },
      { title: "귀항편 우선", description: "울도에서 나오는 편은 기상과 운항 계획의 영향을 받을 수 있습니다. 섬 안 일정 전에 덕적도 또는 인천으로 돌아가는 귀항편을 먼저 확인하세요." },
    ],
    source: { label: "한국해운조합 승선예약에서 최종 확인", href: BOOKING },
    tourHref: "/tour/uldo",
    tourLabel: "울도 관광지 안내 보기",
  },
  deokjeokdo: {
    title: "인천 · 덕적도 이용 안내",
