...
export const TOUR_GUIDES: TourGuide[] = [
  {
    ...
    sourceNote: "2026-09-08 보강. 완도문화관광의 청산권 안내와 한국관광공사의 범바위·신흥해수욕장 소개를 참고했습니다. 범바위 이름에 얽힌 이야기는 전설이며, 해변의 모습은 조위에 따라 달라집니다. 지도는 장소 검색 링크입니다. 이동 준비에 관한 문장은 FerryCast의 이용 제안이며 운영시간·교통편을 확인한 정보는 아닙니다.",
    updated: "2026-09-08",
    sourceLabel: "완도문화관광",
    ...
    places: [
      ...
      },
      {
        name: "범바위",
        category: "자연 경관",
        description: "청계리에 있는 바위로, 호랑이가 자신의 울음보다 크게 되울리는 소리를 듣고 더 큰 호랑이가 있다고 여겨 도망쳤다는 전설이 이름에 전해집니다. 청산도의 마을·해변 산책과 달리 바위 지형을 살펴보는 탐방지로 구분하면 좋습니다. 주변 보적산 정상에서는 범바위와 권덕리, 바다가 함께 보이지만 보적산 등산과 범바위 방문은 같은 일정이 아닙니다. 당일 귀항한다면 욕심내어 두 곳을 모두 묶기보다 걷는 체력과 돌아갈 시간을 먼저 따져보세요.",
        mapQuery: "청산도 범바위",
        officialHref: "https://english.visitkorea.or.kr/svc/contents/contentsView.do?vcontsId=102867",
      },
      {
        name: "상서마을 옛담장",
        category: "마을 · 돌담길",
      ...
      },
      {
        name: "신흥리해수욕장",
        category: "해변",
        description: "지리청송해변과는 청산도 반대편에 있는 넓은 모래 해변입니다. 썰물에는 모래밭이 넓게 드러나고 밀물에는 마을 앞까지 바닷물이 들어와, 같은 장소도 물때에 따라 인상이 달라집니다. 한국관광공사는 지리청송해변보다 편의시설과 방풍림이 적은 곳으로 소개합니다. 그늘에서 오래 쉬는 일정이라면 햇빛을 피할 준비와 마실 물을 챙기고, 물이 빠졌다고 드러난 모래밭 끝까지 무리하게 걷지는 마세요. 풍경 산책과 해수욕은 별개이므로 수영 가능 구역과 안전요원 운영은 현장 안내를 따르세요.",
        mapQuery: "청산도 신흥리해수욕장",
        officialHref: "https://korean.visitkorea.or.kr/detail/ms_detail.do?cotid=4c30d544-3b5f-4eae-867c-3afb559315c9",
      },
    ],
  },
  {
