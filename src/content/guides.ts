...
const CURATED_ROUTE_GUIDES: Guide[] = [
  ...
  {
    slug: "incheon-baengnyeongdo",
    regionSlug: "incheon",
    regionName: "인천",
    destination: "백령도",
    liveGroupKey: "baengnyeongdo",
    title: "인천 백령도 배편 — 용기포항·기항지·출발 전 확인",
    description: "인천항에서 백령도 용기포항으로 가는 장거리 여객선 이용 안내입니다. 기항지, 안개·풍랑에 따른 운항 변동, 귀항편 확인 방법을 정리했습니다.",
    keywords: ["인천 백령도 배편", "백령도 여객선", "인천 백령도 배", "백령도 용기포항", "백령도 배편 예약"],
    liveHref: "/incheon",
    updated: "2026-09",
    intro: [
      "인천에서 백령도로 가는 배편은 인천항 연안여객터미널에서 출발해 백령도 용기포항으로 들어가는 서해 장거리 항로입니다. 같은 항로에 소청도·대청도가 함께 표시될 수 있어, 출발 시각뿐 아니라 내가 내릴 섬과 당일 기항 순서를 함께 확인해야 합니다.",
      "서해 장거리 항로는 안개·풍랑과 운항 계획의 영향을 받습니다. 여행일에는 FerryCast의 편별 운항 상태를 먼저 보고, 결항·대기·지연 또는 참고 시간표 표기가 있으면 선사와 터미널의 최종 안내를 확인하세요.",
    ],
    facts: [
      { label: "출발 터미널", value: "인천항 연안여객터미널" },
      { label: "도착 항구", value: "백령도 용기포항여객터미널" },
      { label: "항로 특징", value: "소청도·대청도 기항 가능 · 편별 항로 확인" },
      { label: "여행 성격", value: "장거리 서해 도서 항로 · 당일 운항 상태 중요" },
      { label: "승선 준비", value: "승선권·실물 신분증·집결 시각" },
      { label: "귀항 확인", value: "백령도 출발 편의 운항일·기항지·시각 별도 확인" },
    ],
    sections: [
      {
        id: "terminal",
        title: "인천에서는 어디서 출발하나요?",
        paragraphs: [
          "백령도행은 인천항 연안여객터미널에서 출발합니다. 인천에는 섬마다 출발 장소가 다른 항로도 있으므로, 출발 전 승선권에 적힌 터미널과 집결 시각을 다시 확인하세요.",
          "승선 절차에는 신분 확인이 필요합니다. 모바일 승선권을 사용하더라도 신분증 준비 여부와 발권 방식은 예약한 선사 안내에 따라 확인하는 것이 안전합니다.",
        ],
        checklist: [
          "승선권의 출발일·집결 시각·출발 터미널 확인",
          "실물 신분증과 예약 정보 준비",
          "터미널 도착 뒤의 발권·승선 절차 확인",
        ],
      },
      {
        id: "stops",
        title: "백령도만 보고 승선하지 마세요",
        paragraphs: [
          "인천항 연안 항로도에는 인천-소청도-대청도-백령도를 잇는 항로가 안내됩니다. 같은 날에도 선박과 편에 따라 기항 순서 또는 실제 하선 시각이 달라질 수 있으므로, 백령도 용기포항에서 내리는 편이 맞는지 예약 내역과 당일 안내를 함께 보세요.",
          "소청도·대청도에서 내리는 승객과 같은 배를 이용하는 경우가 있어, 단순히 ‘백령도행’이라는 표기만으로 도착 순서와 소요시간을 확정하면 안 됩니다.",
        ],
      },
      {
        id: "weather",
        title: "안개·풍랑이 있으면 어떻게 확인하나요?",
        paragraphs: [
          "해무나 풍랑이 있으면 모든 편이 동시에 정상 운항으로 바뀌지 않을 수 있습니다. 일부 편만 운항하거나 대기·지연으로 표시될 수 있으므로, 노선 전체의 한 줄 상태보다 편별 상태를 확인하는 것이 중요합니다.",
          "FerryCast에서 결항·비운항 또는 데이터 조회 실패가 보이면 출발을 확정하지 말고, 예약한 선사와 인천항 터미널의 당일 공지를 확인하세요. 항만에 도착한 뒤에도 운항 계획이 바뀔 수 있습니다.",
        ],
      },
      {
        id: "return",
        title: "귀항편을 먼저 확인해야 하는 이유",
        paragraphs: [
          "백령도에서 인천으로 나오는 배는 별도 시간표와 운항 상태를 가집니다. 숙소·관광·연결 교통을 확정하기 전, 용기포항 출발 귀항편의 운항일과 시각을 먼저 확인하세요.",
          "기상으로 출항 또는 귀항이 바뀌면 다음 날 일정에도 영향을 줄 수 있습니다. 특히 당일 인천 도착 뒤 항공·기차·장거리 버스로 연결할 계획이라면 충분한 여유를 두는 편이 안전합니다.",
        ],
      },
    ],
    sourceNote: "2026년 9월 기준 인천항만공사의 연안 항로도와 FerryCast에 수록된 인천 항로 정보를 바탕으로 정리했습니다. 실제 기항지·운항·승선 조건은 출발일의 선사와 터미널 안내가 우선합니다.",
    sources: [
      { label: "인천항만공사 연안 항로도", href: "https://www.icpa.or.kr/jfile/pdfView.do?fileId=%21%40%24%2And66CUuzqVYAo0P2hFG3txzGtaP0Zk0OWCk9uhgF1WI%3D%21%40%24%2A&fileSeq=%21%40%24%2Aaq7vmdC9nms9iflmKHldKw%3D%3D%21%40%24%2A", note: "인천-소청도-대청도-백령도 연안 항로 확인" },
      { label: "한국해운조합 승선예약", href: "https://island.theksa.co.kr/page/booking", note: "출발일 운항·예매·승선 조건 최종 확인" },
    ],
    tips: [
      "출발 당일에는 집에서 한 번, 터미널로 출발하기 전 한 번 편별 운항 상태를 확인하세요.",
      "숙소·관광 예약 시에는 용기포항 실제 하선 시각 이후의 이동 여유를 두세요.",
      "귀항편이 불확실한 날에는 인천 도착 뒤 연결 일정에 여유 시간을 확보하세요.",
    ],
    faqs: [
      {
        q: "인천에서 백령도 배는 어디서 타나요?",
        a: "인천항 연안여객터미널에서 출발합니다. 예약한 편의 승선권에 적힌 집결 시각과 발권 안내를 함께 확인하세요.",
      },
      {
        q: "백령도 가는 배는 소청도·대청도를 경유하나요?",
        a: "인천-소청도-대청도-백령도를 잇는 연안 항로가 안내되어 있습니다. 실제 기항지와 하선 순서는 편별로 다를 수 있으므로 예약 내역과 당일 선사 안내를 확인하세요.",
      },
      {
        q: "오늘 인천 백령도 배가 뜨나요?",
        a: "이 페이지의 실시간 박스 또는 인천 화면에서 백령도 편별 상태를 확인하세요. 결항·지연·조회 실패 표시는 선사와 터미널 공지로 다시 확인해야 합니다.",
      },
      {
        q: "백령도에서 인천으로 바로 돌아올 수 있나요?",
        a: "귀항편은 별도 시간표입니다. 백령도 용기포항 출발 편의 운항일·시각·기항지를 확인한 뒤 일정과 숙소를 정하세요.",
      },
    ],
    bookingUrl: "https://island.theksa.co.kr/page/booking",
    bookingNote: "출발일 운항 상태와 승선 가능 여부는 한국해운조합 승선예약 또는 예약한 선사의 안내가 우선",
    relatedGuides: [
      { label: "운항·결항·비운항 표시 읽는 법", href: "/guide/ferry-status" },
      { label: "백령도 도착 뒤 관광지 안내 보기", href: "/tour/baengnyeongdo" },
    ],
  },
]
