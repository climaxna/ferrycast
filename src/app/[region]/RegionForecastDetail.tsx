...
import WeatherIcon, { weatherIconTone } from "@/components/WeatherIcon"
...
export default function RegionForecastDetail({ forecast, regionName, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col bg-white" style={{ height: "100dvh" }}>
      <div className="flex items-center gap-3 border-b border-slate-100 px-4 py-4">
        ...
        <div>
          <h2 className="text-lg font-bold tracking-tight text-slate-900">{regionName} 단기 날씨 예보</h2>
