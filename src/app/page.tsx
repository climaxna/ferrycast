        ...
        <div className="mx-auto flex max-w-lg items-center gap-2.5 px-4 py-3">
          ...
          <div className="flex-1">
            <h1 className="text-lg font-bold leading-none tracking-tight text-white">
              Ferry<span className="text-sky-400">Cast</span>
            </h1>
          ...
          <Link
            href="/qr"
            aria-label="QR 코드"
            className="inline-flex items-center gap-1.5 rounded-full px-3 py-2 text-xs font-medium text-slate-500 transition-colors hover:bg-slate-800 hover:text-sky-400"
          >
        ...
        <footer className="rounded-2xl border border-slate-800 bg-slate-900 p-4">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <a
              ...
              className="inline-flex items-center gap-1.5 rounded-lg border border-slate-700 bg-slate-800 px-3.5 py-2.5 text-sm font-medium text-slate-400 transition-colors hover:border-sky-800 hover:text-sky-400"
            >
              완도군청 여객선
            </a>
            <a
