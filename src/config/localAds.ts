...
// 전면 이미지 광고 슬롯의 가로/세로 비. 390px 화면(카드 폭 358px)에서 약 80px 높이.
// 광고를 아래로 여러 개 쌓아도 배편 시간표를 화면 밖으로 밀지 않는 선. 배너 제작 규격(1350x300)도 이 값 기준.
export const AD_SLOT_RATIO = 4.5
...
export const PREVIEW_AD: LocalAd = {
  ...
  imageW: 1200,
  imageH: 675,
  // ⏸ 미게재 — 받은 원본이 16:9라 슬롯(4.5:1)에 넣으면 위아래가 크게 잘린다.
  // 1350x300 규격으로 다시 받기로 하고, 미리보기는 그때까지 빈 자리(AdSlotFrame)만 보여준다.
